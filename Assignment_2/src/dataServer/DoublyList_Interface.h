...
List Create(int);      // Create an empty doubly linked list
...
int IsFull(List);  // I check if a Doubly Linked List is full
...
//Auxiliary Function
ListNode make(Item, char*);   // Return a node 
int item(ListNode, char *);    // Return the item of one node
